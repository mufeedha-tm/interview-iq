  ...
  return (
    <div className="app-shell px-4 py-4 sm:px-5 lg:px-6">
      ...
      <div className="mx-auto max-w-[1440px] space-y-4">
        <header ref={headerRef} className="sticky-glass glass-panel hero-mesh rounded-[24px] px-4 py-4 md:px-5">
          <div className="relative z-10 flex flex-col gap-4">
            <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
              <div className="flex items-center gap-4">
                <Brand />
                <div className="status-chip status-chip-neutral hidden lg:inline-flex">
              ...
              <div className="hidden flex-col gap-3 md:flex lg:flex-row lg:items-center">
                <div className="relative w-full lg:w-auto">
                  <form
                    ...
                    className="search-shell lg:w-[430px]"
                  >
                    ...
                    {search ? (
                      <button
                        type="button"
                        className="rounded-full px-2 py-1 text-[11px] font-semibold uppercase tracking-[0.12em] text-ink-400 transition hover:bg-ink-100 hover:text-ink-700 dark:text-ink-300 dark:hover:bg-white/8 dark:hover:text-white"
                        onClick={() => {
                          setSearch('')
                          setSuggestions([])
                          setSuggestionsOpen(false)
                ...
                <div className="flex items-center gap-3 rounded-[22px] border border-white/10 bg-ink-950/96 px-3 py-2.5 text-white shadow-[0_18px_42px_rgba(7,17,31,0.22)] dark:bg-ink-800">
                  <div className="flex h-10 w-10 items-center justify-center rounded-2xl bg-white/10 font-semibold">{initials}</div>
                  <div>
              ...
              <button
                type="button"
                className="inline-flex items-center gap-2 self-end rounded-2xl bg-white/92 px-3 py-2.5 text-sm font-semibold text-ink-700 ring-1 ring-ink-200/90 transition hover:bg-white dark:bg-ink-800/92 dark:text-white dark:ring-white/10 dark:hover:bg-ink-700 md:hidden"
            ...
            <div className="border-t border-ink-100 pt-4 dark:border-white/10">
              ...
              >
                ...
                <div className="status-chip status-chip-neutral w-fit lg:hidden">
                  {user?.subscriptionTier === 'premium'
                    ? `${user.premiumInterviewsRemaining ?? 0} premium credits`
                    : 'Free plan'}
                </div>
        ...
        <main className="glass-panel rounded-[24px] p-4 md:p-6">
          <Outlet />
        </main>
      </div>
    </div>
